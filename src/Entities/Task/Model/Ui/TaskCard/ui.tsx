...
const TaskCard = ({ name,id, description, status, tag, color, deleteFun, editFun }: Props) => {
    ...
    <div className="card" id={id}>
      <div className="header">
        ...
        <div className="edit-del">
          <Button onClick={editCard} className="edit-icon" label={
          ...
          <Button onClick={deleteCard} className="x-icon" label={
